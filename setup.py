...
PACKAGES = ['ZenPacks', 'ZenPacks.community', 'ZenPacks.community.VMwareESXiMonitor']
INSTALL_REQUIRES = ['ZenPacks.zenoss.ZenossVirtualHostMonitor>=2.3.0', 'ZenPacks.community.VMwareDataSource>=1.0']
